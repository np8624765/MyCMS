...
.op { width:100%; padding:5px 0px 0px 320px;}
  ...
  <table class="wrap" cellspacing="0">
    ...
    <tr class="mid">
      ...
      <div class="content">
            ...
            <span>在这里，您可以修改用户的密码！<br /><br />设置完毕后，新密码将作为该用户的登录密码，请牢记。</span>
          </div>
          <form id="myform" action="index.php?action=users_manage&method=update_pwd&uid=<?php echo $uid;?>" method="post">
 	  	<table class="setting" border="0" cellspacing="0">
      	<thead><tr><th>修改密码</th><th></th><th></th></tr></thead>
        <tbody>
            <tr>
                <td>新密码：</td>
