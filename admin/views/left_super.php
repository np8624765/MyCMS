  ...
  <tr>
    <td width="182" valign="top"><div id="container">
      ...
      <div class="content">
        ...
        <ul class="MM">
          <li><a href="index.php?action=web_manage&method=base_setting" target="main">基本设置</a></li>
          <li><a href="index.php?action=web_manage&method=links_manage" target="main">链接管理</a></li>
        </ul>
      </div>
      ...
      <div class="content">
        ...
        <ul class="MM">
		  <li><a href="index.php?action=column_manage&method=add_column" target="main">添加栏目</a></li>
          <li><a href="index.php?action=column_manage&method=show_column" target="main">栏目管理</a></li>
        </ul>
      </div>
      ...
      <h1 class="type"><a href="javascript:void(0)">用户管理</a></h1>
       <div class="content">
        ...
        <ul class="MM">
          <li><a href="index.php?action=users_manage&method=add_users" target="main">添加用户</a></li>
          <li><a href="index.php?action=users_manage&method=show_users" target="main">用户管理</a></li>
        </ul>
      </div>
       ...
       <h1 class="type"><a href="javascript:void(0)">系统安全</a></h1>
      <div class="content">
          <table width="100%" border="0" cellspacing="0" cellpadding="0">
            <tr>
              <td><img src="views/images/menu_topline.gif" width="182" height="5" /></td>
        ...
        <ul class="MM">
          <li><a href="index.php?action=system_safety&method=show_logs" target="main">查看日志</a></li>
        </ul>
      </div>
      ...
      <div class="content">
        ...
        <ul class="MM">
          <li><a href="index.php?action=recycle_manage&method=column_recycle" target="main">栏目回收站</a></li>
          <li><a href="index.php?action=recycle_manage&method=article_recycle" target="main">文章回收站</a></li>
          <li><a href="index.php?action=recycle_manage&method=user_recycle" target="main">用户回收站</a></li>
        </ul>
      </div>
      <!-----------还需其他功能，请仿照以上模式，进行添加------------------>
     </div>
