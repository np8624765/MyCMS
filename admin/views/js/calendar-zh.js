...
Calendar._TT["PREV_YEAR"] = "上一年 (长按左键弹出下拉菜单)";
Calendar._TT["PREV_MONTH"] = "上一月 (长按左键弹出下拉菜单)";
Calendar._TT["GO_TODAY"] = "到今日";
Calendar._TT["NEXT_MONTH"] = "下一月 (长按左键弹出下拉菜单)";
Calendar._TT["NEXT_YEAR"] = "下一年 (长按左键弹出下拉菜单)";
