...
K.options = {
	...
	htmlTags : {
		...
		embed : ['id', 'class', 'src', 'width', 'height', 'type', 'loop', 'pluginspage','allowfullscreen','autostart', 'flashvars','quality', '.width', '.height', 'align', 'allowscriptaccess'],
		...
		iframe : ['id', 'name' , 'class', 'src', 'frameborder', 'width', 'height', '.width', '.height', 'onload' , 'scrolling'],
...
function _mediaType(src) {
	...
	if (/\.(swf|flv|mp4|f4v|m3u8|webm|ogg)(\?|$)/i.test(src)) {
...
function _mediaEmbed(attrs) {
	...
	_each(attrs, function(key, val) {
		if(key == 'src'){
			html += key + '="' + 'admin/ckplayer/ckplayer.swf" ';
			if(attrs['autostart']=='0') {
				html += 'flashvars="f=' + val + '&p=0" ';
			}else{
				html += 'flashvars="f=' + val + '&p=1" ';
			}	
		}
	...
	html += ' quality="high" align="middle" allowScriptAccess="always" allowFullscreen="true" wmode="transparent" />';
	return html;
}
